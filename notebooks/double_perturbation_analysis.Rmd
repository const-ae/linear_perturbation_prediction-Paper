...
```{r, paged.print=FALSE}
lower_thres_fun1 <- nonlin_fun(p1 = c(lower_thres, -0.6), p2 = c(0, lower_thres), vec1 = c(0.01, 0.1), vec2 = 0.2 * c(1,1), extrapolate_factor = c(2, 0))
lower_thres_fun2 <- nonlin_fun(p1 = c(0.6, upper_thres), p2 = c(upper_thres, 0), vec1 = -c(0.1, 0.01), vec2 = -0.2 * c(1,1), extrapolate_factor = c(2, 0))
